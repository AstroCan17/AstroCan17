...
- $\textcolor{red}{\text{Ground Segment System Software Engineering - Satellite Camera Design, Calibration and Image Preprocessing}}$
...
- $\textcolor{red}{\text{Remote Sensing Software Engineer}}$
   - $\textcolor{yellow}{\text{Tools \& Skills}}$
